...
export default function HomePage() {
  const bestCourses = [
    {
      title: "AI-Powered Teaching Toolkit",
      org: "Daffodil Smart Academy",
      level: "Professional",
    ...
    {
      title: "BRAC Data Science Foundation",
      org: "BRAC Learning Center",
      level: "Standard",
      href: "/catalog/data-analytics-with-excel",
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80",
    },
    {
      title: "Cybersecurity for University Labs",
      org: "Tepantor Institute",
      level: "Professional",
      href: "/catalog/compliance-excellence-bootcamp",
      image:
        "https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=1200&q=80",
    },
    {
      title: "MERN Bootcamp for Job Readiness",
      org: "Dhaka Skill Hub",
      level: "Basic+",
      href: "/catalog/full-stack-web-development",
      image:
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {bestCourses.map((course) => (
            <Link
              key={course.title}
              href={course.href}
              className="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-indigo-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-900 dark:hover:border-indigo-400"
            >
              <div
